...
export declare const createTypeScriptSandbox: (partialConfig: Partial<SandboxConfig>, monaco: Monaco, ts: typeof import("typescript")) => {
    ...
    supportedVersions: readonly ["4.7.1-rc", "4.7.0-beta", "4.6.4", "4.5.5", "4.4.4", "4.3.5", "4.2.3", "4.1.5", "4.0.5", "3.9.7", "3.8.3", "3.7.5", "3.6.3", "3.5.1", "3.3.3", "3.1.6", "3.0.1", "2.8.1", "2.7.2", "2.4.1"];
